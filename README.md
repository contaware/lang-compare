...
| **Read** | `mylist[index]`<br>`mydict['k1']` | `arr[index]`<br>`map.get('k1')`<br>`obj['k1']`<br>`obj.k1` | `$arr[index]`<br>`$arr['k1']` |
| **Add** | `mylist.append(2)`<br>`mydict['k3'] = 3`<br>`s.add("v2")` | `arr.push(2)`<br>`map.set('k3', 3)`<br>`obj['k3'] = 3`<br>`s.add("v2")` | `$arr[] = 2`<br>`$arr['k3'] = 3` |
| **Del** | `mylist.pop(index)`<br>`mydict.pop('k3')`<br>`s.remove("v2")` | `arr.pop()`<br>`map.delete('k3')`<br>`delete obj['k3']`<br>`s.delete("v2")` | `array_pop($arr)`<br>`unset($arr['k1'])` |
